...
class SelfAttention(nn.Module):
    ...
    def forward(self, values, keys, query, mask):
        ...
        # Split embeddin into self.heads pieces
        ...
        # after einsum (N, query_len, heads, head_dim) then flatten the last 2 dimensions
...
class Decoder(nn.Module):
    def __init__(
        ...
        self.device = device
        self.word_embedding = nn.Embedding(target_vocab_size, embedding_dim=emebed_size)
        self.position_embedding = nn.Embedding(max_length, embedding_dim=emebed_size)
